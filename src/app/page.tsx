          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
            ...
            <Link href="/shop" style={{ textDecoration: 'none', color: 'inherit' }}>
              <motion.div 
                ...
                whileHover={{ y: -10, boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }}
              >
                <div style={{ height: '260px', overflow: 'hidden', position: 'relative', background: '#f0f0f0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <img src="/shop/kit_officiel_polo_condor.png" style={{ width: '100%', height: '100%', objectFit: 'contain', padding: '10px' }} alt="Boutique Condor" />
